...
const VIDEOS = [
  ...
  },
  {
    ...
    subtitle: 'The plan habit — from wish to motion, and then to ambition.',
    description: 'Look around your life. There\'s a half-painted wall, an app you stopped using, a business plan in a drawer. Usually just one thing missing: the concrete next step. But this isn\'t only about starting small things — the same habit scales up. The complicated projects you\'d previously have called too big are suddenly plannable. Dependencies mapped, contingencies spelled out, second-order effects surfaced. Capable people can be quietly more ambitious.',
    duration: '5:33',
    runtime: 333,
  ...
  },
  {
    id: 'imagine',
    episode: 'Episode 05',
    title: 'Ideas that died on the vine.',
    subtitle: 'The imagine habit — what becomes conceivable, and what becomes tryable.',
    description: 'There are two kinds of ideas that never happened: the ones you had but couldn\'t pursue, and the ones you never had at all because they lived at intersections nobody in your life brought together. Both kinds now have a chance. Episode five: a small habit for making the invisible visible — to yourself, and to someone else.',
    duration: '6:10',
    runtime: 370,
  ...
  {
    id: 'guide_31',
    episode: 'Episode 06 (A/B)',
    title: 'The patient teacher used to be rationed. — 3.1 Flash TTS',
    subtitle: 'Same script, narrated with Gemini 3.1 Flash TTS instead of 2.5 Pro. For A/B comparison only.',
    description: 'Identical script and visuals to Episode 06 above. Only the narrator TTS model differs: this version uses gemini-3.1-flash-tts-preview (faster, released 2026-04-15). The version above uses the series\' canonical gemini-2.5-pro-preview-tts. Listen to both and tell Justin which sounds right.',
    duration: '6:37',
    runtime: 397,
    src: `${VIDEO_STORAGE_BASE}/guide_31.mp4`,
    ready: true,
  },
];
